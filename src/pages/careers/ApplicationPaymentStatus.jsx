...
export default function ApplicationPaymentStatus() {
  ...
  // Purana deployed verify fn leadType 'career' na bheje to snapshot se confirm
  const isCareer = result ? result.leadType === 'career' || !!(snapshot?.applicationId || snapshot?.id) : false;
