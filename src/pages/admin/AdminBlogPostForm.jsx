        ...
        <div className="card-base bg-white p-6 sm:p-8 space-y-5">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted mt-1.5">
              Tip: URL mein <b>https://</b> zaroor ho. Upload karne par image Supabase{' '}
              <code>blog-assets</code> bucket mein save hoti hai.
            </p>
          ...
          <div>
            ...
            />
            <p className="text-[11px] text-muted mt-1.5">
              Ye text blog ke end mein author name &amp; role ke niche dikhta hai. Khali
              chhodo to default bio use hogi.
            </p>
          </div>
          ...
          <div className="border-2 border-dashed border-secondary/20 p-4 sm:p-5 bg-accent/40">
            ...
            <p className="text-xs text-muted mb-3 leading-relaxed">
              Agar aap chahte ho ki reader ye blog padhne ke baad kisi page par jaye
              (course, service, contact, ya koi bhi website link) &mdash; to yahan
              button ka text aur link daalo. Khali chhodo to button nahi dikhega.
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
            ...
            <p className="text-[11px] text-muted mt-2">
              Internal page link <code>/course</code> ya <code>/services</code> bhi chalega,
              aur full external link <code>https://...</code> bhi (naye tab mein khulega).
            </p>
          </div>
