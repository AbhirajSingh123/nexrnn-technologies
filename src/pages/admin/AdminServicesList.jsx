  ...
  return (
    <div>
      ...
      <div className="relative w-full sm:w-72 mb-4">
        ...
        <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search service, slug…"
      ...
      <div className="mb-4">
        <ExportButtons rows={filtered} columns={columns} filename="services" title="Services" />
      </div>
      {loading ? (
        <LoadingSpinner />
      ) : (
